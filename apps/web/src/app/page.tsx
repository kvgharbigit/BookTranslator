        ...
        <div className="text-center mb-20">
          ...
          <div className="flex items-center gap-2 text-sm text-neutral-600 mb-8">
            <div className="flex -space-x-2">
              ...
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-green-400 to-green-600 border-2 border-white flex items-center justify-center text-white text-xs font-semibold">AL</div>
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 border-2 border-white flex items-center justify-center text-white text-xs font-semibold">+200K</div>
            </div>
        ...
        <div className="mt-20 bg-white/80 backdrop-blur-sm rounded-xl p-8 border-2 border-neutral-200 shadow-sm">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <div className="w-full sm:w-[calc(50%-0.5rem)] lg:w-[calc(20%-0.8rem)] bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-2xl p-4 text-center hover:shadow-lg transform hover:-translate-y-1 transition-all duration-200">
              ...
              <div className="w-full sm:w-[calc(50%-0.5rem)] lg:w-[calc(20%-0.8rem)] bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-300 rounded-2xl p-4 text-center hover:shadow-lg transform hover:-translate-y-1 transition-all duration-200 relative">
              ...
              <div className="w-full sm:w-[calc(50%-0.5rem)] lg:w-[calc(20%-0.8rem)] bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-200 rounded-2xl p-4 text-center hover:shadow-lg transform hover:-translate-y-1 transition-all duration-200">
              ...
              <div className="w-full sm:w-[calc(50%-0.5rem)] lg:w-[calc(20%-0.8rem)] bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-200 rounded-2xl p-4 text-center hover:shadow-lg transform hover:-translate-y-1 transition-all duration-200">
              ...
              <div className="w-full sm:w-[calc(50%-0.5rem)] lg:w-[calc(20%-0.8rem)] bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-4 text-center hover:shadow-lg transform hover:-translate-y-1 transition-all duration-200">
                    ...
                    <div className="space-y-2 text-xs">
                      <div className="flex justify-between items-center p-2 bg-neutral-50 rounded">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-orange-600 font-semibold">4x more</div>
                        </div>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-neutral-50 rounded">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-orange-600 font-semibold">3.4x more</div>
                        </div>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-neutral-50 rounded">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-orange-600 font-semibold">2x more</div>
                        </div>
                      </div>
                    </div>
                  </div>
